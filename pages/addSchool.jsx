...
export default function AddSchool() {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 m-3 bg-gradient-to-tr from-sky-300 from-30% via-cyan-300 via-65% to-cyan-400 to-80% shadow-md rounded-lg">
      <div>
        <Link href="/showSchools">
            <button 
              className="bg-green-500 border border-green-600 text-white p-2 rounded-lg w-full md:w-auto hover:bg-green-600 transition duration-200">
              View School
            </button>
          </Link>
      ...
      >
        ...
        <div className="px-1">
          <button 
            type="submit" 
            className="bg-blue-500 border border-blue-600 text-white p-3 rounded-lg w-full md:w-auto hover:bg-blue-600 transition duration-200">
            Add School
          </button>
        </div>
      </form>
